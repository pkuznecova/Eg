...
st.markdown("""
Эта мини-программа использует модель машинного обучения для предсказания ширины запрещённой зоны (Eg) на основе доли замещения кальция на европий в кристалле шеелита CaWO₄.
""")
...
st.caption("🔬 Данные: Ca₁₋ₓEuₓWO₄, спектроскопия в uv-vis-области, 2025")
